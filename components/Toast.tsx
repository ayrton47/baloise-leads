...
export function Toast({ toast }: ToastProps) {
  ...
  return (
    ...
    >
      <div
        className={`flex items-center gap-3 px-4 py-3 rounded-lg border ${colorMap[toast.type]} shadow-lg transition-colors`}
        role="alert"
      >
        ...
        <button
          onClick={handleClose}
          className={`flex-shrink-0 ml-2 rounded p-1 transition-colors ${closeColorMap[toast.type]}`}
