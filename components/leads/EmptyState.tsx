...
export default function EmptyState({ type, onAddLead, onClearFilters }: EmptyStateProps) {
  if (type === 'no-leads') {
    return (
      <div className="text-center py-24 px-4">
        ...
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 transition-colors">Aucun lead pour le moment</h3>
        <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-md mx-auto transition-colors">
  ...
  return (
    <div className="text-center py-24 px-4">
      ...
      <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 transition-colors">Aucun résultat</h3>
      <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-md mx-auto transition-colors">
      ...
      <div className="flex gap-3 justify-center">
        <button
          ...
          className="px-6 py-3 rounded-xl font-bold text-[#00358E] dark:text-blue-300 bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-all border-2 border-blue-100 dark:border-blue-800"
        >
          Effacer les filtres
        </button>
        <button
